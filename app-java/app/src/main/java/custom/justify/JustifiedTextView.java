...
public class JustifiedTextView extends View {
    ...
    private List<String> divideOriginalTextToStringLineList(String originalText) {
        ...
        for (int j = 0; j < listParageraphes.length; j++)
        {
            ...
            for (int i = 0; i < arrayWords.length; i++) {
                ...
                //else if text width excite textAreaWidth then remove last word and custom.justify the StringLine
                    ...
                    //and then we need to custom.justify line
    ...
    /***
     * Sets the string value of the JustifiedTextView. JustifiedTextView does not accept HTML-point formatting.
