...
public class CardViewLabel extends CardView {
  LabelViewHelper utils;
  public CardViewLabel(Context context) {
    this(context, null);
  }
  public CardViewLabel(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }
  public CardViewLabel(Context context, AttributeSet attrs, int defStyleAttr) {
