...
public class JalaliCalendar {
     ...
     * @param dateMiladi is whit format "yyyy-mm-dd HH:mm:ss" or of  server format "Y-m-d H:i:s"
     */
    public static String convertToJalaliMyFormat(String dateMiladi,String pattern){
        Calendar cal = Calendar.getInstance();
        DateFormat format = new SimpleDateFormat(pattern, Locale.ENGLISH);
        String dateJalali = "";
        try {
            Date date = format.parse(dateMiladi);
            cal.setTime(date);
           ...
           JalaliCalendar jalaliDate = new JalaliCalendar(new GregorianCalendar(year, month, day));
            dateJalali =jalaliDate.year+"/"+jalaliDate.month+"/"+jalaliDate.day+"   "+hour+":"+minute+":"+second;
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return dateJalali;
    }
    public static String convertToJalaliMyFormat(String dateMiladi){
        Calendar cal = Calendar.getInstance();
