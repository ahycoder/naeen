 ...
 * Project: Calligraphy
 */
class FontLayoutInflater extends LayoutInflater implements FontActivityFactory {
    ...
    private final FontFactory mCalligraphyFactory;
    // Reflection Hax
    private boolean mSetPrivateFactory = false;
    private Field mConstructorArgs = null;

    protected FontLayoutInflater(Context context, int attributeId) {
        super(context);
        mAttributeId = attributeId;
        mCalligraphyFactory = new FontFactory(attributeId);
        setUpLayoutFactories(false);
    }

    protected FontLayoutInflater(LayoutInflater original, Context newContext, int attributeId, final boolean cloned) {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new FontLayoutInflater(this, newContext, mAttributeId, true);
    }
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, mCalligraphyFactory));
    ...
    private void setPrivateFactoryInternal() {
        ...
        if (!FontConfig.get().isReflection()) return;
    ...
    private View createCustomViewInternal(View parent, View view, String name, Context viewContext, AttributeSet attrs) {
        ...
        if (!FontConfig.get().isCustomViewCreation()) return view;
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final FontLayoutInflater mInflater;
        private final FontFactory mCalligraphyFactory;

        public WrapperFactory(Factory factory, FontLayoutInflater inflater, FontFactory calligraphyFactory) {
            mFactory = factory;
            mInflater = inflater;
    ...
    private static class WrapperFactory2 implements Factory2 {
        ...
        protected final FontFactory mCalligraphyFactory;

        public WrapperFactory2(Factory2 factory2, FontFactory calligraphyFactory) {
            mFactory2 = factory2;
            mCalligraphyFactory = calligraphyFactory;
        }
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        public PrivateWrapperFactory2(Factory2 factory2, FontLayoutInflater inflater, FontFactory calligraphyFactory) {
