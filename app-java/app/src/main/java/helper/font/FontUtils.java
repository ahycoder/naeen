...
public final class FontUtils {
     ...
     *                 {@link Spannable}'s.
     * @return true if applied otherwise false.
     * @see #applyFontToTextView(TextView, Typeface)
     */
    ...
    static void applyFontToTextView(final Context context, final TextView textView, final FontConfig config) {
        applyFontToTextView(context, textView, config, false);
    }

    static void applyFontToTextView(final Context context, final TextView textView, final FontConfig config, boolean deferred) {
     ...
     *                     defined font.
     */
    public static void applyFontToTextView(final Context context, final TextView textView, final FontConfig config, final String textViewFont) {
        applyFontToTextView(context, textView, config, textViewFont, false);
    }

    static void applyFontToTextView(final Context context, final TextView textView, final FontConfig config, final String textViewFont, boolean deferred) {
        if (context == null || textView == null || config == null) return;
